...
local severityDescriptors = {
  {
    id = "error",
    level = 4,
    icon = "Interface\\AddOns\\WeakAuras\\Media\\Textures\\HelpIcon-Bug",
    title = L["Error"]
  },
  {
    id = "warning",
    level = 3,
    icon = "Interface\\AddOns\\WeakAuras\\Media\\Textures\\ServicesAtlas",
    title = L["Warning"]
  },
  {
    id = "tts",
    level = 2,
    icon = "Interface\\AddOns\\WeakAuras\\Media\\Textures\\chatframe-button-icon-TTS",
    title = L["Text To Speech"]
  },
  {
    id = "sound",
    level = 1,
    icon = "Interface\\AddOns\\WeakAuras\\Media\\Textures\\chatframe-button-icon-voicechat",
    title = L["Sound"]
  },
  {
    id = "info",
    level = 0,
    icon = "Interface\\AddOns\\WeakAuras\\Media\\Textures\\friendsframe-informationicon.blp",
    title = L["Information"]
  }
}
